...
// enemies left
// NOTE: is temporary, until there is a level & scoring system. Just gives players
//		 some kind of goal for now to make it at least a tad bit fun in alpha phase
var enemy_count_string = "Enemy count: " + string(obj_master_controller.enemy_count);
draw_set_color(c_yellow);
draw_text(CELL_WIDTH / 2, CELL_HEIGHT / 2, "Enemy count: " + string(obj_master_controller.enemy_count));